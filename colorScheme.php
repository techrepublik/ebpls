...
echo "<tr><td colspan=2 bgcolor='blue' align=center><font size=3 color='white'><b>Color Scheme Preferences</b></font></td></tr>\n";
echo "<form action='writeColorScheme.php' method='post'>";
