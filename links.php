...
<body>
<form name=_FRM action="index.php?part=4selMode=links" ENCTYPE="multipart/form-data" method="post">
<input type=hidden name=part value="<?php echo $part;?>">
<input type=hidden name=selMode value="<?php echo $selMode;?>">
<table border=0 width=100% align=center cellspacing=0 cellpadding=0>
<tr><td colspan=2 class=header2 align=center width=100%>Links</td></tr>
...
?>
		<td>
		<a href='http://<?php echo stripslashes($get_info[1]); ?>'>
		<?php echo stripslashes($get_info[2]); ?></a>
</td>
		</tr>
<?php
		}
