...
-- 
-- Host: localhost
-- Generation Time: Jan 01, 2002 at 07:00 PM
...
CREATE TABLE comparative_statement (
...
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (1, 'EBPLS', 'part=4\n', '2002-01-01 18:59:18');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (2, 'EBPLS', 'part=4&permit_type=Settings&busItem=Settings&item_id=Settings\n', '2002-01-01 18:59:22');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (3, 'EBPLS', 'part=4&itemID_=7&busItem=Settings&permit_type=Settings&settings_type=UserManager&item_id=Settings\n', '2002-01-01 18:59:24');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (4, 'EBPLS', 'frmThreadId=4&frmDomain=\n', '2002-01-01 18:59:34');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (5, 'EBPLS', '\n', '2002-01-01 18:59:35');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (6, 'EBPLS', 'part=4&itemID_=7&busItem=Settings&permit_type=Settings&settings_type=UserManager&item_id=Settings\n', '2002-01-01 18:59:36');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (7, 'EBPLS', 'frmThreadId=3&frmDomain=\n', '2002-01-01 18:59:51');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (8, 'EBPLS', '\n', '2002-01-01 18:59:53');
INSERT INTO ebpls_activity_log (act_id, user_log, logged, date_input) VALUES (9, 'EBPLS', 'part=4&itemID_=7&busItem=Settings&permit_type=Settings&settings_type=UserManager&item_id=Settings\n', '2002-01-01 18:59:54');
...
CREATE TABLE ebpls_announcement (
...
CREATE TABLE ebpls_business_category (
...
CREATE TABLE ebpls_business_enterprise (
...
CREATE TABLE ebpls_business_enterprise_permit (
...
CREATE TABLE ebpls_buss_approve (
...
CREATE TABLE ebpls_buss_assessment (
...
CREATE TABLE ebpls_buss_complex (
...
CREATE TABLE ebpls_buss_monthlyref (
  id int(4) NOT NULL auto_increment,
...
CREATE TABLE ebpls_buss_nature (
...
CREATE TABLE ebpls_buss_penalty (
  id int(11) NOT NULL auto_increment,
...
CREATE TABLE ebpls_buss_penalty1 (
  id int(11) NOT NULL auto_increment,
  mdue date default NULL,
...
INSERT INTO ebpls_buss_penalty1 (id, mdue, semdue1, semdue2, qtrdue1, qtrdue2, qtrdue3, qtrdue4, revdate) VALUES (1, '0000-00-00', '', '', '', '', '', '', '2002-01-01 18:59:18');
...
CREATE TABLE ebpls_buss_preference (
...
CREATE TABLE ebpls_buss_requirements (
...
CREATE TABLE ebpls_buss_taxfee (
  natureid int(11) default NULL,
...
CREATE TABLE ebpls_buss_taxfee_option (
...
CREATE TABLE ebpls_buss_taxfeeother (
  taxfeeid int(11) NOT NULL auto_increment,
  natureid int(11) default NULL,
...
CREATE TABLE ebpls_buss_taxfeetype (
...
CREATE TABLE ebpls_buss_taxrange (
...
CREATE TABLE ebpls_citizenship (
...
CREATE TABLE ebpls_city_municipality (
...
CREATE TABLE ebpls_comm_tax_cert (
...
CREATE TABLE ebpls_ctc_business (
...
CREATE TABLE ebpls_ctc_individual (
...
CREATE TABLE ebpls_economic_area (
...
CREATE TABLE ebpls_economic_org (
...
CREATE TABLE ebpls_engine_type (
...
CREATE TABLE ebpls_fee_exemption (
...
CREATE TABLE ebpls_fish_description (
...
CREATE TABLE ebpls_fishery_fees (
...
CREATE TABLE ebpls_fishery_permit (
...
CREATE TABLE ebpls_franchise_fees (
  fee_id int(10) NOT NULL auto_increment,
  fee_desc varchar(255) default NULL,
...
CREATE TABLE ebpls_franchise_owner (
  owner_id int(11) NOT NULL auto_increment,
  owner_first_name varchar(60) NOT NULL default '',
  owner_middle_name varchar(60) NOT NULL default '',
  owner_last_name varchar(60) NOT NULL default '',
...
CREATE TABLE ebpls_franchise_permit (
...
CREATE TABLE ebpls_industry_sector (
...
CREATE TABLE ebpls_mot_penalty (
...
CREATE TABLE ebpls_motorized_operator_permit (
...
CREATE TABLE ebpls_motorized_operators (
...
CREATE TABLE ebpls_motorized_penalty (
  id int(11) NOT NULL auto_increment,
...
CREATE TABLE ebpls_motorized_vehicles (
...
CREATE TABLE ebpls_mtop_temp_fees (
...
CREATE TABLE ebpls_occupancy_type (
...
CREATE TABLE ebpls_occupational_permit (
...
CREATE TABLE ebpls_other_penalty (
  id int(11) NOT NULL auto_increment,
  renewaldate varchar(5) default NULL,
  rateofpenalty varchar(10) default NULL,
  rateofinterest varchar(10) default NULL,
...
CREATE TABLE ebpls_other_penalty_amount (
...
CREATE TABLE ebpls_peddlers_fees (
  fee_id int(11) NOT NULL auto_increment,
  fee_desc varchar(255) default NULL,
  fee_amount int(10) default NULL,
  permit_type varchar(20) default NULL,
...
CREATE TABLE ebpls_peddlers_permit (
...
CREATE TABLE ebpls_tax_exemption (
...
CREATE TABLE ebpls_transaction_payment_check (
...
CREATE TABLE ebpls_transaction_payment_or (
...
CREATE TABLE ebpls_transaction_payment_or_details (
...
CREATE TABLE ebpls_transaction_requirements (
...
INSERT INTO ebpls_user (id, level, csgroup, username, password, lastname, firstname, designation, email, gsmnum, login, logout, lockout, currthreads, roundrobinflag, dateadded, lastupdated) VALUES (1, 'ã', NULL, 'ebpls', '°eæw', 'EBPLS', 'EBPLS', '', '', '', '2002-01-01 18:59:18', '2002-01-01 03:33:24', NULL, NULL, NULL, '2006-07-06 09:56:38', '2002-01-01 18:59:18');
INSERT INTO ebpls_user (id, level, csgroup, username, password, lastname, firstname, designation, email, gsmnum, login, logout, lockout, currthreads, roundrobinflag, dateadded, lastupdated) VALUES (2, 'ã', NULL, 'NCCFOO', '»]vìkL', 'FOO', 'NCC', '', '', '', '2009-01-30 19:05:42', '2009-01-30 19:05:42', NULL, NULL, NULL, '2006-07-06 09:57:11', '2009-01-30 19:05:42');
...
CREATE TABLE ebpls_user_sublevel (
...
CREATE TABLE ebpls_user_sublevel_listings (
...
CREATE TABLE motor_application (
  rowid int(10) NOT NULL auto_increment,
  username varchar(20) default NULL,
  driver varchar(255) default NULL,
  address varchar(255) default NULL,
...
INSERT INTO user_session (ses_id, ip_add, ses_code, user_id, date_input) VALUES (1, '192.168.101.245', 'fa61f876de60915ffa125ff6a4c173c5', 1, '2002-01-01 18:59:54');
