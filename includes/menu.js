...
function Menu(label) {
    ...
    this.type = "Menu";
    document.bgColor = menuScheme(0);
    this.fontSize = menuScheme(1);
    this.fontWeight =  menuScheme(2);
    this.fontFamily = menuScheme(3);
    this.fontColor = menuScheme(4);
    this.fontColorHilite = menuScheme(5);
    this.bgColor = menuScheme(6);
    this.menuBorder = menuScheme(7);
    this.menuItemBorder = menuScheme(8);
    this.menuItemBgColor = menuScheme(9);
    this.menuLiteBgColor = "#ffffff";
    this.menuBorderBgColor = "#777777";
    this.menuHiliteBgColor = menuScheme(10);
...
function writeMenus(container) {
    ...
    if (document.layers) {
        ...
        for (var x=0; x<container.menus.length; x++) {
            ...
            proto.menuItemWidth = proto.menuItemWidth || 300;
