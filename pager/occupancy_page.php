...
<a href='index.php?part=4&class_type=Preference&selMode=<?php echo $selMode;?>&action_=8&itemEvent=1&data_item=0&orderkey=occupancy_type_code&is_desc=<?php echo $is_desc;?>'>
&nbsp;Occupancy Code</a>
</td>
                        <td align=center class='hdr'>
<a href='index.php?part=4&class_type=Preference&selMode=<?php echo $selMode;?>&action_=8&itemEvent=1&data_item=0&orderkey=occupancy_type_desc&is_desc=<?php echo $is_desc;?>'> 
&nbsp;Occupancy Type</a></td>
...
print "<td width=10%>&nbsp;$get_infor[occupancy_type_code]&nbsp</td>\n";
print "<td width=6%>&nbsp;$get_infor[occupancy_type_desc]&nbsp</td>\n";
print "<td align=center width=24%>&nbsp;<a href='index.php?part=4&class_type=Preference&selMode=$selMode&action_=8&itemEvent=1&data_item=0&com=edit&bbo=$get_infor[occupancy_type_code]' class='subnavwhite'>Edit</a> | ";
                                                                                                                                                            
?>
<a class='subnavwhite' href='#' onclick='javascript:confdel("<?php echo $get_infor['occupancy_type_code']; ?>");'>Delete</a>
