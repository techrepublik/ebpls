...
<a href='index.php?part=4&class_type=Preference&selMode=<?php echo $selMode;?>&action_=8&itemEvent=1&data_item=0&orderkey=cit_desc&is_desc=<?php echo $is_desc;?>'>
&nbsp;Fish Activity Description</a>
</td>
...
print "<td width=75%>&nbsp;$get_infor[fish_desc]&nbsp</td>\n";
print "<td align=center width=25%>&nbsp;<a href='index.php?part=4&class_type=Preference&selMode=$selMode&action_=8&itemEvent=1&data_item=0&com=edit&bbo=$get_infor[fish_id]' class='subnavwhite'>Edit</a> | ";
                                                                                                                                                            
?>
<a class='subnavwhite' href='#' onClick="javascript: confdel('<?php echo $get_infor[fish_id]; ?>');">Delete</a>
