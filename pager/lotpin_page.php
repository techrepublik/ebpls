...
echo "<table border=0 width=100%><tr><td align=left><br />";
 if($pager > 1){
			...
			echo "<a href='index.php?part=4&class_type=Preference&selMode=ebpls_nannouncement&page=1&orderkey=$orderkey&is_asc=$is_asc'>&lt;&lt;&nbsp;</a>";
                        echo "<a href='index.php?part=4&class_type=Preference&selMode=ebpls_nannouncement&page=$prevr&orderkey=$orderkey&is_asc=$is_asc'>Prev&nbsp;";
                        }
...
print "<td width=40%>&nbsp;$get_infor[announcements]&nbsp</td>\n";
print "<td width=15%>&nbsp;$get_infor[announced_by]&nbsp</td>\n";
...
echo "<table border=0 width=100%><tr><td align=left><br />";
 if($pager > 1){
                        $prevr = ($pager - 1);
                        echo "<a href='index.php?part=4&class_type=Preference&selMode=ebpls_nannouncement&page=1&orderkey=$orderkey&is_asc=$is_asc'>&lt;&lt;&nbsp;";
                        echo "<a href='index.php?part=4&class_type=Preference&selMode=ebpls_nannouncement&page=$prevr&orderkey=$orderkey&is_asc=$is_asc'>Prev&nbsp;";
                        }
