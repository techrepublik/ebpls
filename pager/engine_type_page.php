...
print "<td width=75%>&nbsp;$get_infor[engine_type_desc]&nbsp</td>\n";
print "<td align=center width=25%>&nbsp;<a href='index.php?part=4&class_type=Preference&selMode=$selMode&action_=8&itemEvent=1&data_item=0&com=edit&bbo=$get_infor[engine_type_id]' class='subnavwhite'>Edit</a> | ";
                                                                                                                                                            
?>
<a class='subnavwhite' href='#' onClick="javascript: confdel('<?php echo $get_infor[engine_type_id]; ?>');">Delete</a>
