...
//echo $is_desc."VooDoo";
if ($orderkey=="") {
	$orderkey = "economic_org_code";
}
$nresult = new EBPLSEconomicOrg($dbLink,'false');
...
<a href='index.php?part=4&class_type=Preference&selMode=<?php echo $selMode;?>&action_=8&itemEvent=1&data_item=0&orderkey=economic_org_code&is_desc=<?php echo $is_desc;?>'>
&nbsp;Economic Organization Code</a>
</td>
<td align=center class='hdr'> 

<a href='index.php?part=4&class_type=Preference&selMode=<?php echo $selMode;?>&action_=8&itemEvent=1&data_item=0&orderkey=economic_org_desc&is_desc=<?php echo $is_desc;?>'>
&nbsp;Economic Organization Description</a>
</td>
...
print "<td width=10%>&nbsp;$get_infor[economic_org_code]&nbsp</td>\n";
print "<td width=10%>&nbsp;$get_infor[economic_org_desc]&nbsp</td>\n";
print "<td align=center width=24%>&nbsp;<a href='index.php?part=4&class_type=Preference&selMode=$selMode&action_=8&itemEvent=1&data_item=0&com=edit&bbo=$get_infor[economic_org_id]' class='subnavwhite'>Edit</a> | ";
                                                                                                                                                            
?>
<a class='subnavwhite' href='#' onClick="javascript: confdel('<?php echo $get_infor[economic_org_id]; ?>');">Delete</a>
