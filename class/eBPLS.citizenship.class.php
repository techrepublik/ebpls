...
function EBPLSCitizenship( $dbLink, $bDebug = false ) {
		...
		$this->addDataElement( CIT_ID, "is_not_empty", "[VALUES]");
		$this->addDataElement( CIT_DESC, "is_not_empty", "[VALUES]");
...
function add(){
	...
	function view( $owner_id ) {
		...
		$result = ebpls_select_data( $this->m_dbLink, EBPLS_CITIZENSHIP_TABLE, $strValues, $strWhere, NULL, $strOrderBy, "DESC", NULL );
