...
Module : eBPLS.zip.code.class.php
...
class EBPLSZipCode extends DataEncapsulator {
	 ...
	 *
	 */
	function EBPLSZipCode( $dbLink, $bDebug = false ) {
	...
	*/
	 ...
	 *
	 */	 
	function search( $zip_code = NULL, $zip_desc = NULL ) {
