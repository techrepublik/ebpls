...
function EBPLSOccupancy( $dbLink, $bDebug = false ) {
		...
		$this->addDataElement( OCCUPANCY_TYPE_CODE, "is_not_empty", "[VALUES]");
		$this->addDataElement( OCCUPANCY_TYPE_DESC, "is_not_empty", "[VALUES]");
		$this->addDataElement( OCCUPANCY_TYPE_DATE_REGISTERED, "is_not_empty", "[VALUES]" );
