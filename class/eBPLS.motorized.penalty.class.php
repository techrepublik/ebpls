...
define(EBPLS_SURCHARGE_TABLE,"ebpls_motorized_penalty");

// Industry Sector Data Elements Constants
define(ID,"id");
define(RENEWALTYPE,"renewaltype");
define(RENEWALDATE1,"renewaldate1");
define(RENEWALDATE2,"renewaldate2");
define(RENEWALDATE3,"renewaldate3");
define(RENEWALDATE4,"renewaldate4");
define(RENEWALDATE5,"renewaldate5");
define(RENEWALDATE6,"renewaldate6");
define(RENEWALDATE7,"renewaldate7");
define(RENEWALDATE8,"renewaldate8");
define(RENEWALDATE9,"renewaldate9");
define(RENEWALDATE0,"renewaldate0");
...
class EBPLSPenalty extends DataEncapsulator {
	...
	function EBPLSPenalty( $dbLink, $bDebug = false ) {
		...
		$this->addDataElement( RENEWALTYPE, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE1, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE2, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE3, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE4, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE5, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE6, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE7, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE8, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE9, "is_not_empty", "[VALUES]");
		$this->addDataElement( RENEWALDATE0, "is_not_empty", "[VALUES]");
	...
	function update( $id ) {
		...
		$ifexist = @mysql_query("select * from ebpls_motorized_penalty where permit_type = '$permit'");
