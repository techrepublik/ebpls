<?php
	function etoms_insert_data( $dbLink, $strTable, $strValues ) {
	...
	function etoms_update_data ( $dbLink, $strTable, $strValues, $strWhere ) {
	...
	function etoms_delete_data ( $dbLink, $strTable, $strWhere ) {
	...
	etoms_db_funcs_debug ( "etoms_delete_data DELETE : $sqlDelete" );

	$res = @mysql_query( $sqlDelete, $dbLink );

	}

	function etoms_select_data ( $dbLink, $strTable, $strColumns, $strWhere = NULL, $strGroupBy = NULL, $strOrder = NULL, $strOrderKey = NULL,  $strLimitMax = NULL, $strLimitOffSet = NULL, $bGetPagingSql = false ) {
	...
	function etoms_fetch_data($dbLink, $result) {
		
		$res = @mysql_fetch_array($result, $dbLink );
	...
	function etoms_start_transaction( $dbLink ){

	global $gETOMSGlobalTransValue;

	if ( $gETOMSGlobalTransValue ) {

		etoms_db_funcs_debug ( "etoms_start_transaction : gETOMSGlobalTransValue still set." );
		return;
