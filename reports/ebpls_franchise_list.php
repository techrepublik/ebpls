...
//Page header
	...
	$this->Cell(340,5,'FRANCHISE REGISTRY',0,1,'C');
...
$date_to = date('Y-m-d', $xdate);
	$result = mysql_query ("select distinct (c.franchise_permit_code) as pid,
...
b.owner_id, a.motorized_motor_id, c.franchise_permit_code
from ebpls_motorized_vehicles a, ebpls_owner b, ebpls_franchise_permit c,
ebpls_barangay f , ebpls_city_municipality g , ebpls_province h where
c.active=1 and a.permit_type='Franchise' and b.owner_id = a.motorized_operator_id and c.owner_id = b.owner_id
...
c.application_date between '$date_from' and '$date_to'
...
$getsignatories = @mysql_query("select * from report_signatories where report_file='Franchise Registry' and sign_type='3'");
