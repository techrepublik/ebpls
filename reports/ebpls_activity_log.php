...
$result=mysql_query("select * from ebpls_activity_log where user_log like '$owner_last%' and date_input between '$date_from ' and '$date_to'") or die(mysql_error());   
...
$pdf->SetFont('Arial','',6);
$pdf->SetX(5);
$pdf->Cell(30,5,$resulta[1],1,0,'L');
$pdf->Cell(280,5,substr($resulta[2],0,250),1,0,'L');
$pdf->Cell(25,5,$resulta[3],1,1,'C');
					}
...
$getsignatories = @mysql_query("select * from report_signatories where report_file='Activity Log List' and sign_type='3'");
