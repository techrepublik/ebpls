...
$sumtaxq1 = mysql_query("select sum(taxes) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=1 and month<=3");
...
$sumtaxq2 = mysql_query("select sum(taxes) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=4 and month<=6");
...
$sumtaxq3 = mysql_query("select sum(taxes) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=7 and month<=9");
$sumtaxq3 = mysql_fetch_row($sumtaxq3);						

$sumtaxq4 = mysql_query("select sum(taxes) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=10 and month<=12");
$sumtaxq4 = mysql_fetch_row($sumtaxq4);						
...
$sumtaxq4n = mysql_query("select sum(taxes) from comparative_statement where for_year='$datenext' and
						paid = 0 and month>=10 and month<=12");
$sumtaxq4n = mysql_fetch_row($sumtaxq4n);						
...
$sumfeeq4 = mysql_query("select sum(fees) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=10 and month<=12");
$sumfeeq4 = mysql_fetch_row($sumfeeq4);						
...
$sumfeeq4n = mysql_query("select sum(fees) from comparative_statement where for_year='$datenext' and
						paid = 0 and month>=10 and month<=12");
$sumfeeq4n = mysql_fetch_row($sumfeeq4n);						
...
$sumpenq4 = mysql_query("select sum(penalty) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=10 and month<=12");
$sumpenq4 = mysql_fetch_row($sumpenq4);						
...
$sumpenq4n = mysql_query("select sum(penalty) from comparative_statement where for_year='$datenext' and
						paid = 0 and month>=10 and month<=12");
$sumpenq4n = mysql_fetch_row($sumpenq4n);						
...
$sumintq4 = mysql_query("select sum(surcharge) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=10 and month<=12");
$sumintq4 = mysql_fetch_row($sumintq4);						
...
$sumintq4n = mysql_query("select sum(surcharge) from comparative_statement where for_year='$datenext' and
						paid = 0 and month>=10 and month<=12");
$sumintq4n = mysql_fetch_row($sumintq4n);						
...
$sumbakq4 = mysql_query("select sum(backtax) from comparative_statement where for_year='$dateprev' and
						paid = 0 and month>=10 and month<=12");
$sumbakq4 = mysql_fetch_row($sumbakq4);						
...
$sumbakq4n = mysql_query("select sum(backtax) from comparative_statement where for_year='$datenext' and
						paid = 0 and month>=10 and month<=12");
$sumbakq4n = mysql_fetch_row($sumbakq4n);						
...
$totalq4 = $sumtaxq4[0]+$sumfeeq4[0]+$sumpenq4[0]+$sumintq4[0]+$sumbakq4[0];
...
if ($sumtaxq4[0]==0) {
	$percentdifftaxq4 = ($difftaxq4/1)*100;
} else {
	$percentdifftaxq4 = ($difftaxq4/$sumtaxq4[0])*100;
}
if ($sumfeeq1[0]==0) {
...
if ($sumfeeq4[0]==0) {
	$percentdifffeeq4 = ($difffeeq4/1)*100;
} else {
	$percentdifffeeq4 = ($difffeeq4/$sumfeeq4[0])*100;
}
if ($sumpenq1[0]==0) {
...
if ($sumpenq4[0]==0) {
	$percentdiffpenq4 = ($diffpenq4/1)*100;
} else {
	$percentdiffpenq4 = ($diffpenq4/$sumpenq4[0])*100;
}
if ($sumintq1[0]==0) {
...
if ($sumintq4[0]==0) {
	$percentdiffintq4 = ($diffintq4/1)*100;
} else {
	$percentdiffintq4 = ($diffintq4/$sumintq4[0])*100;
}
if ($sumbakq1[0]==0) {
...
if ($sumbakq4[0]==0) {
	$percentdiffbakq4 = ($diffbakq4/1)*100;
} else {
	$percentdiffbakq4 = ($diffbakq4/$sumbakq4[0])*100;
}
if ($totalq1==0) {
...
if ($totalq4==0) {
	$percentdifftotq4 = ($difftotq4/1)*100;
} else {
	$percentdifftotq4 = ($difftotq4/$totalq4)*100;
}
...
$percentdifftaxq4 = number_format($percentdifftaxq4,2);
...
$percentdifffeeq4 = number_format($percentdifffeeq4,2);
...
$percentdiffpenq4 = number_format($percentdiffpenq4,2);
...
$percentdiffintq4 = number_format($percentdiffintq4,2);
...
$percentdiffbakq4 = number_format($percentdiffbakq4,2);
...
$percentdifftotq4 = number_format($percentdifftotq4,2);
...
$pdf->SetX(35);
$pdf->Cell(80,5,'YEAR 1 ('.$dateprev.')',1,0,'C');
$pdf->SetX(115);
$pdf->Cell(80,5,'YEAR 2 ('.$datenext.')',1,0,'C');
$pdf->SetX(195);
$pdf->Cell(60,5,'% DIFFERENCE',1,0,'C');
$pdf->SetX(255);
$pdf->Cell(80,5,'AMOUNT DIFFERENCE',1,1,'C');

$pdf->SetX(5);
$pdf->Cell(30,5,'',1,0,'C');
$pdf->Cell(20,5,'Q1',1,0,'C');
$pdf->Cell(20,5,'Q2',1,0,'C');
$pdf->Cell(20,5,'Q3',1,0,'C');
$pdf->Cell(20,5,'Q4',1,0,'C');
$pdf->Cell(20,5,'Q1',1,0,'C');
$pdf->Cell(20,5,'Q2',1,0,'C');
$pdf->Cell(20,5,'Q3',1,0,'C');
$pdf->Cell(20,5,'Q4',1,0,'C');
$pdf->Cell(15,5,'Q1',1,0,'C');
$pdf->Cell(15,5,'Q2',1,0,'C');
$pdf->Cell(15,5,'Q3',1,0,'C');
$pdf->Cell(15,5,'Q4',1,0,'C');
$pdf->Cell(20,5,'Q1',1,0,'C');
$pdf->Cell(20,5,'Q2',1,0,'C');
$pdf->Cell(20,5,'Q3',1,0,'C');
$pdf->Cell(20,5,'Q4',1,1,'C');

$pdf->SetX(5);
$pdf->Cell(30,5,'TAXES',1,0,'L');
$pdf->SetX(35);
$pdf->Cell(20,5,$sumtaxq1[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq2[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq3[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq4[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq1n[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq2n[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq3n[0],1,0,'C');
$pdf->Cell(20,5,$sumtaxq4n[0],1,0,'C');
$pdf->Cell(15,5,$percentdifftaxq1,1,0,'C');
$pdf->Cell(15,5,$percentdifftaxq2,1,0,'C');
$pdf->Cell(15,5,$percentdifftaxq3,1,0,'C');
$pdf->Cell(15,5,$percentdifftaxq4,1,0,'C');
$pdf->Cell(20,5,$difftaxq1,1,0,'C');
$pdf->Cell(20,5,$difftaxq2,1,0,'C');
$pdf->Cell(20,5,$difftaxq3,1,0,'C');
$pdf->Cell(20,5,$difftaxq4,1,1,'C');


$pdf->SetX(5);
$pdf->Cell(30,5,'FEES',1,0,'L');
$pdf->SetX(35);
$pdf->Cell(20,5,$sumfeeq1[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq2[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq3[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq4[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq1n[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq2n[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq3n[0],1,0,'C');
$pdf->Cell(20,5,$sumfeeq4n[0],1,0,'C');
$pdf->Cell(15,5,$percentdifffeeq1,1,0,'C');
$pdf->Cell(15,5,$percentdifffeeq2,1,0,'C');
$pdf->Cell(15,5,$percentdifffeeq3,1,0,'C');
$pdf->Cell(15,5,$percentdifffeeq4,1,0,'C');
$pdf->Cell(20,5,$difffeeq1,1,0,'C');
$pdf->Cell(20,5,$difffeeq2,1,0,'C');
$pdf->Cell(20,5,$difffeeq3,1,0,'C');
$pdf->Cell(20,5,$difffeeq4,1,1,'C');

$pdf->SetX(5);
$pdf->Cell(30,5,'PENALTIES',1,0,'L');
$pdf->SetX(35);
$pdf->Cell(20,5,$sumpenq1[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq2[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq3[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq4[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq1n[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq2n[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq3n[0],1,0,'C');
$pdf->Cell(20,5,$sumpenq4n[0],1,0,'C');
$pdf->Cell(15,5,$percentdiffpenq1,1,0,'C');
$pdf->Cell(15,5,$percentdiffpenq2,1,0,'C');
$pdf->Cell(15,5,$percentdiffpenq3,1,0,'C');
$pdf->Cell(15,5,$percentdiffpenq4,1,0,'C');
$pdf->Cell(20,5,$diffpenq1,1,0,'C');
$pdf->Cell(20,5,$diffpenq2,1,0,'C');
$pdf->Cell(20,5,$diffpenq3,1,0,'C');
$pdf->Cell(20,5,$diffpenq4,1,1,'C');

$pdf->SetX(5);
$pdf->Cell(30,5,'SURCHARGES',1,0,'L');
$pdf->SetX(35);
$pdf->Cell(20,5,$sumintq1[0],1,0,'C');
$pdf->Cell(20,5,$sumintq2[0],1,0,'C');
$pdf->Cell(20,5,$sumintq3[0],1,0,'C');
$pdf->Cell(20,5,$sumintq4[0],1,0,'C');
$pdf->Cell(20,5,$sumintq1n[0],1,0,'C');
$pdf->Cell(20,5,$sumintq2n[0],1,0,'C');
$pdf->Cell(20,5,$sumintq3n[0],1,0,'C');
$pdf->Cell(20,5,$sumintq4n[0],1,0,'C');
$pdf->Cell(15,5,$percentdiffintq1,1,0,'C');
$pdf->Cell(15,5,$percentdiffintq2,1,0,'C');
$pdf->Cell(15,5,$percentdiffintq3,1,0,'C');
$pdf->Cell(15,5,$percentdiffintq4,1,0,'C');
$pdf->Cell(20,5,$diffintq1,1,0,'C');
$pdf->Cell(20,5,$diffintq2,1,0,'C');
$pdf->Cell(20,5,$diffintq3,1,0,'C');
$pdf->Cell(20,5,$diffintq4,1,1,'C');

$pdf->SetX(5);
$pdf->Cell(30,5,'BACK TAX',1,0,'L');
$pdf->SetX(35);
$pdf->Cell(20,5,$sumbakq1[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq2[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq3[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq4[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq1n[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq2n[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq3n[0],1,0,'C');
$pdf->Cell(20,5,$sumbakq4n[0],1,0,'C');
$pdf->Cell(15,5,$percentdiffbakq1,1,0,'C');
$pdf->Cell(15,5,$percentdiffbakq2,1,0,'C');
$pdf->Cell(15,5,$percentdiffbakq3,1,0,'C');
$pdf->Cell(15,5,$percentdiffbakq4,1,0,'C');
$pdf->Cell(20,5,$diffbakq1,1,0,'C');
$pdf->Cell(20,5,$diffbakq2,1,0,'C');
$pdf->Cell(20,5,$diffbakq3,1,0,'C');
$pdf->Cell(20,5,$diffbakq4,1,1,'C');

$pdf->SetX(5);
$pdf->Cell(30,5,'TOTAL',1,0,'L');
$pdf->SetX(35);
$pdf->Cell(20,5,$totalq1,1,0,'C');
$pdf->Cell(20,5,$totalq2,1,0,'C');
$pdf->Cell(20,5,$totalq3,1,0,'C');
$pdf->Cell(20,5,$totalq4,1,0,'C');
$pdf->Cell(20,5,$totalq1n,1,0,'C');
$pdf->Cell(20,5,$totalq2n,1,0,'C');
$pdf->Cell(20,5,$totalq3n,1,0,'C');
$pdf->Cell(20,5,$totalq4n,1,0,'C');
$pdf->Cell(15,5,$percentdifftotq1,1,0,'C');
$pdf->Cell(15,5,$percentdifftotq2,1,0,'C');
$pdf->Cell(15,5,$percentdifftotq3,1,0,'C');
$pdf->Cell(15,5,$percentdifftotq4,1,0,'C');
$pdf->Cell(20,5,$difftotq1,1,0,'C');
$pdf->Cell(20,5,$difftotq2,1,0,'C');
$pdf->Cell(20,5,$difftotq3,1,0,'C');
$pdf->Cell(20,5,$difftotq4,1,1,'C');
