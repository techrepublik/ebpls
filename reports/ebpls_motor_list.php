...
//Page header
	...
	$this->Cell(340,5,'MASTER LIST OF MOTOR VEHICLES',0,1,'C');
	$this->SetFont('Arial','B',12);
...
$pdf->Cell(25,5,'AMOUNT PAID',1,1,'C');
...
b.owner_id, a.motorized_motor_id, c.motorized_permit_code, b.owner_id
...
c.active=1 and c.paid = 1 and a.permit_type='Motorized' and b.owner_id = a.motorized_operator_id and c.owner_id = b.owner_id
...
c.motorized_operator_permit_application_date between '$date_from 00:00:00' and '$date_to 23:59:59'
and b.owner_barangay_code like '$brgy_name'");
	...
	while ($resulta=mysql_fetch_array($result))
	{
		...
		$getor = mysql_query("select sum(amount_due) from ebpls_transaction_payment_or_details where trans_id = '$resulta[owner_id]' and ts between '$date_from 00:00:00' and '$date_to 23:59:59' and permit_type='Motorized'");

		$getor = mysql_fetch_row($getor);
		$pdf->SetX(5);
		$pdf->Cell(5,5,$i,1,0,'R');
		$pdf->Cell(20,5,$resulta[pid],1,0,'C');
$pdf->Cell(60,5,$resulta[fulln],1,0,'L');
$pdf->Cell(80,5,$resulta[owner_add],1,0,'L');
$pdf->Cell(25,5,$resulta[motorized_motor_model],1,0,'L');
$pdf->Cell(25,5,$resulta[motorized_motor_no],1,0,'L');
$pdf->Cell(25,5,$resulta[motorized_body_no],1,0,'L');
$pdf->Cell(25,5,$resulta[motorized_chassis_no],1,0,'L');
$pdf->Cell(25,5,$resulta[motorized_plate_no],1,0,'L');
$pdf->Cell(25,5,$resulta[body_color],1,0,'L');
$pdf->Cell(25,5,number_format($getor[0],2),1,0,'R');
		$qute=0;
		$i++;
		$total_++;
		$ntot = $ntot + $getor[0];
...
$pdf->Cell(25,5,number_format($ntot,2),0,1,'C');
$pdf->Cell(60,5,'',0,0,'C');
$pdf->Cell(80,5,'',0,0,'C');
$pdf->Cell(25,5,'',0,0,'C');
$pdf->Cell(25,5,'',0,0,'C');
