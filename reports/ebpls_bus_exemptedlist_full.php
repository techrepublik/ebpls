...
if ($option==99) {
	$parti = "f.tax_exemption between '1' and '99'";
} elseif ($option==100) {
	$parti = "f.tax_exemption ='100'";
} else {
	$parti = "f.tax_exemption between '1' and '9999'";
}
...
frederick >>> change this:
	...
	b.owner_id, a.business_id, f.business_category_desc, f.tax_exemption 
        from ebpls_business_enterprise a, ebpls_owner b, ebpls_business_enterprise_permit c,
	tempbusnature d, ebpls_buss_nature e, ebpls_business_category f where
        d.active=1 
...
$getsignatories = @mysql_query("select * from report_signatories where report_file='Exempted Business Establishment' and sign_type='3'");
