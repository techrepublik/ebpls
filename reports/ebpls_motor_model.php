...
//Page header
	...
	$this->Cell(340,5,'LISTING OF MOTOR VEHICLE BY MODEL',0,1,'C');
	$this->Ln(22);
	}
...
$pdf->SetX(320);
$pdf->Cell(30,5,'BODY NUMBER',1,0,'C');
...
*/
	...
	while ($resulta=mysql_fetch_row($result))
	{
		...
		$pdf->SetX(320);
		$pdf->Cell(30,5,$resulta[5],1,0,'L');	//body number
		$i++;
		$pdf->SetY($pdf->GetY()+5);
	} 
...
$report_desc='Masterlist of Motor Vehicle By Model';
